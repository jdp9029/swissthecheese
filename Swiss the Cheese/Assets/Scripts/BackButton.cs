...
public class BackButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(SceneManager.GetActiveScene().name == "Options")
        {
            ...
            masterSlider.onValueChanged.AddListener(delegate { audioMixer.SetFloat("masterVolume", 20f * Mathf.Log10(masterSlider.value)); });
            fxSlider.onValueChanged.AddListener(delegate { audioMixer.SetFloat("soundFXVolume", 20f * Mathf.Log10(fxSlider.value)); });
            musicSlider.onValueChanged.AddListener(delegate { audioMixer.SetFloat("musicVolume", 20f * Mathf.Log10(musicSlider.value)); });
        }
